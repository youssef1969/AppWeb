...
let input1 = document.getElementById("listGroupEtu");
let input2 = document.getElementById("listProf");

autocomplete(input1,listeGroupe);
autocomplete(input2,listeProf);

const zoneFlex = document.getElementsByClassName("inputZoneFlex");
for (let zone of zoneFlex) {
	zone.addEventListener("click", function(e) {
		let res = zone.getElementsByTagName("input");
		for (let a of res) {
			if (a.classList.contains("inputReel")) {
				a.focus();
			}
		}
	})
